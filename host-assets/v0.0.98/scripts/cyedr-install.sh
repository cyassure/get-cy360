...
#     --impl python|go       Which agent implementation to install (default: python).
#                            "go" installs the Go-rewrite binary (agent-go) instead of
#                            the default PyInstaller agent — dogfooding/testing only as
#                            of 2026-09-05, not a supported production default yet.
#     --help                 Show this help
